...
healtawal = 100
potionawal = 1
let lolkey = 'e1838e06263fd49903164a95' //Daftar Atau Beli Di lolhuman.xyz
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • selldiamond`)
        ...
        //+++ || FAKE TROLI         
        const troli =  {key: { fromMe: false,remoteJid: "status@broadcast", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 2022, status: 200, thumbnail: tamnel, surface: 200, message: `𝗭𝗘𝗘𝗦𝗘𝗟𝗙𝗕𝗢𝗧`, orderTitle: 'LordKrisna', sellerJid: '0@s.whatsapp.net'} } }    

        const katalog = (teks) => {
             res = zee.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 999999999, "message": teks, "footerText": "©Ryuuka", "jpegThumbnail": fs.readFileSync('./media/zeebot.jpg'), "surface": 'CATALOG' }}, {quoted:troli})
...
//»»»𝘉𝘶𝘵𝘵𝘰𝘯 𝘉𝘢𝘮𝘩 
    ...
    case 'group': case 'gc': case 'grup':     	 
          ...
          sendButton(from, menu, 'Created By Krisna', but, troli)
          break           
...
${q+=1}.term`)        
          ...
          sendButton(from, pp, 'Created By Krisna', but, troli)
          break         
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET:ahmadkrisna345@gmail.com\n` +
            `item2.X-ABLabel:📧 Email\n` +
            `item3.URL:https://instagram.com/krisnazx_/\n` +
            `item3.X-ABLabel:⚙️ Instagram Owner\n` +
            `item4.ADR:;;🇮🇩 Indonesia;;;;\n` +
            `item4.X-ABADR:ac\n` +
            `item4.X-ABLabel:🌍 Region\n` +
            `item5.X-ABLabel:⚔️ Ryuuka - Botz Owner\n` +
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `KrisnaZx`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
   ...
   default:
          ...
          sendButton(from, menu, 'Created By Krisna', but, mek)
          break
          }
